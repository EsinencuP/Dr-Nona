...
export const MASTERCLASS_TOPIC_LABELS_RO: Record<
  MasterclassTopic,
  string
> = {
  "Комплексный уход за кожей и антивозрастные программы Halo Complex":
  ...
  "Индивидуальный подбор продукции и дегустация текстур":
    "Selectarea individuală a produselor și testarea texturilor",
  "Общая презентация оздоровительной линии Dr. Nona":
    "Prezentarea generală a gamei pentru bunăstare Dr. Nona",
};
