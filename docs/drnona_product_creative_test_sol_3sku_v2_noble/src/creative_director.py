    ...
    return {
        ...
        "composition": {
            "clean-card": {
                "canvas": [1600, 1600],
                "transparent": False,
                "background": "site-palette; Lord uses deep navy",
                "shadow": "subtle contact shadow",
            },
            "hero": {
                "canvas": [2048, 2048],
                "product_height_ratio": [0.40, 0.50],
                "decor_groups": [3, 5],
                "empty_center": True,
                "grounded_on_surface": True,
                "role": "rich product-card scene",
            },
            "ingredients": {
                "canvas": [2048, 2048],
                "max_decor_groups": 5,
